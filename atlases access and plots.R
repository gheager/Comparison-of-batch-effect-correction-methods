...
get(load('Human Expression Atlas/Human Expression Atlas ComBat.Rdata')) -> Human.Expression.Atlas.ComBat
...
)+geom_text(size=3) + scale_colour_manual(values=colours20 %>% rep(3))+theme(legend.position = 'none')
...
get(load('Mouse Expression Atlas/Mouse Expression Atlas ComBat.Rdata')) -> Mouse.Expression.Atlas.ComBat
...
get(load('Corn Expression Atlas/Corn Expression Atlas ComBat.Rdata')) -> Corn.Expression.Atlas.ComBat
